...
export default function App() {
  ...
  useEffect(() => {
    try {
      ...
      keys.forEach((key, i) => {
        try {
          const val = localStorage.getItem("physio_" + key);
  ...
  useEffect(() => {
    if (!loaded) return;
    try {
      localStorage.setItem("physio_staff", JSON.stringify(staff));
      localStorage.setItem("physio_docs", JSON.stringify(docs));
      localStorage.setItem("physio_equipment", JSON.stringify(equipment));
      localStorage.setItem("physio_audits", JSON.stringify(audits));
      localStorage.setItem("physio_hsRecords", JSON.stringify(hsRecords));
      localStorage.setItem("physio_standards", JSON.stringify(standards));
    } catch {}
