...
const INIT_MEETINGS=[
  ...
  {id:3306,date:"2025-11-28",clinic:"Titirangi",topic:"Titirangi bi-monthly meeting — Quinn joining December, Hans mentor role for 2026, year review, Christmas planning",attendees:"Jade Warren, Hans Vermeulen, Samuel Warren, Gemma",notes:"Present: Jade, Hans, Samuel, Gemma. Strong year despite the flood disruption at the start. S&C services well established with Gemma. Quinn confirmed to join in December 2025 — will be doing a couple of days a week working between Panmure and Titirangi. Discussed Hans taking on more of a mentoring role for 2026 — supporting newer staff, clinical oversight, professional development guidance. VALD and force plate outcomes data reviewed — valuable for athlete clients and building clinic reputation. Group class planning progressing with Gemma. Christmas closure dates confirmed. Housekeeping: end-of-year equipment maintenance, clinic tidy before Christmas, holiday hours signage needed. Action items: Jade — prepare Quinn's onboarding materials by 5 Dec. Hans — draft mentor role scope and expectations for 2026 by 20 Dec. Gemma — finalise group class launch plan for early 2026. Samuel — complete year-end patient data summary by 15 Dec. All — confirm Christmas leave dates to Jade by 1 Dec."},
  // 2026
  {id:3401,date:"2026-01-30",clinic:"Titirangi",topic:"Titirangi bi-monthly meeting — Quinn settling in, Hans mentor role, 2026 goals, clinic profile",attendees:"Jade Warren, Hans Vermeulen, Quinn",notes:"Present: Jade, Hans, Quinn. Quinn started in December and settling in — working a couple of days between Panmure and Titirangi. Getting familiar with systems and patient flow. Hans stepping into mentor role for 2026 — will be supporting Quinn and other newer staff across the practice. Discussed continuing to push the clinic profile — updated branding, community presence, social media. S&C programmes with Gemma continuing strong. APC renewals due April — Hans and Jade both on track. CPD planning for the year reviewed. Housekeeping: New Year clinic reset done, supplies ordered, treatment rooms checked. Action items: Hans — begin structured mentoring sessions with Quinn, first session by 14 Feb. Quinn — complete Titirangi orientation items by 28 Feb. Jade — progress clinic branding refresh, get design concepts by 28 Feb. Hans — confirm CPD plan for 2026 by 14 Feb."},
  {id:3402,date:"2026-03-27",clinic:"Titirangi",topic:"Titirangi bi-monthly meeting — website and bio updates, APC renewals, clinic revamp progress",attendees:"Jade Warren, Hans Vermeulen, Quinn",notes:"Present: Jade, Hans, Quinn. Website updates completed in February/March — new staff profiles, updated clinic info, refreshed branding across the site. All staff bios updated and live. APC renewals April 2026 confirmed for Hans. Clinical notes audit completed for Hans — all compliant. Quinn settling in well, getting good patient feedback. S&C services with Gemma in high demand. Hans mentor role going well — regular sessions with Quinn and contributing to broader team development. Clinic profile push continuing — social media presence growing. Housekeeping: clinic exterior signage refreshed, treatment room curtains replaced, new patient info display installed. Action items: Quinn — complete remaining CPD requirements by 30 Apr. Hans — schedule next in-service presentation topic by 15 Apr. Jade — review clinic branding materials are consistent across all locations by 15 Apr. All — APC renewals to be confirmed by 1 Apr."},
  ...
  {id:4206,date:"2025-12-05",clinic:"Panmure",topic:"Panmure bi-monthly meeting — Stephen farewell, Gwenne and Quinn handover, 2026 planning, Friday leasing",attendees:"Jade Warren, Stephen Gray, Gwenne Manares",notes:"Present: Jade, Stephen, Gwenne. Stephen Gray farewell — exceptional work establishing the Panmure clinic from scratch, building the referral network with GPs, gyms, and sports clubs. GP relationships, gym and sports club partnerships all handed over to Jade and Gwenne. Gwenne Manares introduced to key referrers. Quinn also confirmed to be doing a couple of days working between Panmure and Titirangi from December. Comprehensive handover notes completed by Stephen. Stephen's last day December 19. Discussed leasing out Fridays at the Panmure clinic to Rise and Shine acupuncturist — Joseph Ying. Good opportunity for additional clinic income and service offering for patients. Housekeeping: Christmas closure confirmed, clinic tidy planned, holiday signage up. Action items: Gwenne — familiarise with all handover contacts and referral partners by 31 Dec. Jade — finalise Friday leasing arrangement with Joseph Ying (Rise and Shine) by 20 Dec. Quinn — complete Panmure orientation items by mid-Jan. Jade — confirm 2026 Panmure staffing schedule by 15 Dec."},
