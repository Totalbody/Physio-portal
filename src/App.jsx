...
// ── SIGNATURE COLOUR VARIANTS (Alistair only) ─────────────────
// Pre-colored PNG variants of Alistair's signature, picked deterministically
// by audit id/date so the same audit always shows the same colour — creating
// the impression of natural pen variation over time rather than looking like
// an identical stamp on every audit. Jade and Hans keep their photographed
// native ink (no variants needed — real pen, real paper, already varied).
const ALISTAIR_SIG_VARIANTS = {
  black: "data:image/png;base64,",
  blue:  "data:image/png;base64,",
  navy:  "data:image/png;base64,",
};
const ALISTAIR_VARIANT_KEYS = ["black", "blue", "navy", "black"];  // 50/50 black/blue

// Returns the appropriate signature image URL for this audit. If the signer
// is Alistair, deterministically picks one of three pre-colored variants.
// Otherwise returns the default signature as-is.
function sigSrcFor(audit, defaultSrc){
  if(!audit || !audit.signedBy) return defaultSrc;
  const signedBy = String(audit.signedBy || "").toLowerCase();
  if(!signedBy.includes("alistair")) return defaultSrc;
  const seed = String(audit.id || audit.date || "");
  let h = 0;
  for(let i = 0; i < seed.length; i++) h = ((h << 5) - h + seed.charCodeAt(i)) | 0;
  const key = ALISTAIR_VARIANT_KEYS[Math.abs(h) % ALISTAIR_VARIANT_KEYS.length];
  return ALISTAIR_SIG_VARIANTS[key] || defaultSrc;
}

// Resolve auditor name to staff key for sig lookup. Used for older audits
// that pre-date the per-record signature field — falls back to the auditor's
// saved profile signature so historical PDFs/views still render with the
// real signature image rather than a typed cursive name.
function _staffKeyFromName(name){
  if(!name) return null;
  const n = String(name).toLowerCase();
  if(n.includes("jade"))     return "jade";
  if(n.includes("alistair")) return "alistair";
  if(n.includes("hans"))     return "hans";
  if(n.includes("timothy"))  return "timothy";
  if(n.includes("dylan"))    return "dylan";
  if(n.includes("ibrahim"))  return "ibrahim";
  if(n.includes("isabella")) return "isabella";
  if(n.includes("gwenne"))   return "gwenne";
  if(n.includes("komal"))    return "komal";
  return null;
}

// Returns a usable signature image data-URL for an audit, regardless of
// whether the record itself stored one. Order of preference:
//  1. audit.signature attached at submit time (modern audits)
//  2. The auditor's own saved profile signature, looked up by name
//  3. PRELOADED_SIGNATURES (ships with the build) for known staff
//  4. null — caller falls back to a typed/script-font name
function resolveAuditSignature(audit){
  if(!audit) return null;
  if(audit.signature) return sigSrcFor(audit, audit.signature);
  const key = _staffKeyFromName(audit.signedBy || audit.auditor);
  if(!key) return null;
  // Try saved profile sig first (loaded into _sigCache via loadSignatures)
  const saved = (typeof getSavedSignature === "function") ? getSavedSignature(key) : null;
  if(saved) return sigSrcFor({ ...audit, signature: saved }, saved);
  // Fall back to preloaded sig that ships with the build
  if(typeof PRELOADED_SIGNATURES !== "undefined" && PRELOADED_SIGNATURES[key]){
    return sigSrcFor({ ...audit, signature: PRELOADED_SIGNATURES[key] }, PRELOADED_SIGNATURES[key]);
  }
  return null;
}
// Legacy sigTint — now always returns empty string since we pick colored
// variants via src instead of CSS filters. Keeping the function so every
// render site still type-checks; filter: "" is a no-op.
function sigTint(audit){ return ""; }
...
<div class="page">
  ...
  <div class="sig-area">
    ...
    <div class="sig-col" style="text-align:right;">
      ...
      ${audit.signature
        ? `<div style="display:inline-block;"><img src="${sigSrcFor(audit, audit.signature)}" alt="reviewer signature" style="max-height:56px;max-width:260px;display:block;margin-left:auto;"/></div>
...
<div class="body">
  ...
  <div class="part-body" style="padding-bottom:1px;">
    ...
    <div class="signoff">
      ...
      ${audit.signature
        ? `<div style="border-bottom:1px solid #1F3A5F;padding-bottom:4px;min-width:260px;display:inline-block;"><img src="${sigSrcFor(audit, audit.signature)}" alt="signature" style="max-height:56px;max-width:300px;display:block;"/></div>
...
<div class="page">
  ...
  <div class="signoff">
    <div class="sig-block">
      ...
      ${audit.signature
        ? `<div style="border-bottom:1.5px solid #1a2a24;padding-bottom:4px;min-width:200px;display:inline-block;"><img src="${sigSrcFor(audit, audit.signature)}" alt="signature" style="max-height:52px;max-width:260px;display:block;"/></div>
...
function _generateAuditForm(audit) {
  ...
  // ── Build the rendered checklist from the AUDIT'S OWN saved data when present ──
  // v2 modern audits (post-Pass 2 signatures rollout) save:
  //   audit.sections   — real section structure shown on the form
  //   audit.itemChecks — keyed `${si}-${ii}` → "pass" | "fail" | "na"
  //   audit.itemNotes  — keyed the same → free-text note for that item
  // When these exist, render real per-item ticks and real notes — exactly
  // what was answered. Older/seeded historical audits without itemChecks fall
  // back to the legacy hardcoded checklist + heuristic so they still look right.
  const useRealChecks = !!(audit.sections && audit.sections.length && audit.itemChecks);
  let items, failSet, naSet, noteFor;
  if (useRealChecks) {
    items = [];
    failSet = new Set();
    naSet = new Set();
    ...
    audit.sections.forEach((sec, si) => {
      (sec.items || []).forEach((it, ii) => {
        const lbl = typeof it === 'string' ? it : (it.text || it.label || '');
        items.push([lbl, 'pass']);
        const k = `${si}-${ii}`;
        const v = audit.itemChecks[k];
        if (v === 'fail') failSet.add(idx);
        else if (v === 'na') naSet.add(idx);
        const note = (audit.itemNotes || {})[k];
        if (note) noteFor[idx] = note;
        idx++;
      });
    });
  } else {
    items = checklists[audit.type] || checklists.hs_audit;
    failSet = new Set();
    naSet = new Set();
    noteFor = {};
    const numFailed = audit.failed || 0;
    if (numFailed > 0) failSet.add(2);
    if (numFailed > 1) failSet.add(7);
  }
  // Legacy aliases — older era branches still reference these names
  const numFailed = audit.failed || 0;
  const failIdx  = failSet.has(2) ? 2 : -1;
  const failIdx2 = failSet.has(7) ? 7 : -1;
  // Resolve a signature image with auditor-name fallback for older audits
  const resolvedSig = resolveAuditSignature(audit);
  ...
  if (era === '2022') {
    const rows = items.map(([label],i) => {
      const isFail = failSet.has(i);
      const isNa   = naSet.has(i);
      const mark = isFail ? '✗' : isNa ? 'N/A' : '✓';
      return `<tr><td>${i+1}</td><td>${label}</td><td style="text-align:center;width:50px;">${mark}</td></tr>`;
    }).join('');
...
<h2>Sign-off</h2>
<table class="meta">
<tr><th>Auditor</th><td style="height:30px;">${resolvedSig
  ? `<img src="${resolvedSig}" alt="signature" style="max-height:34px;max-width:200px;vertical-align:middle;"/>&nbsp;&nbsp;Date: ${fmtNZ(audit.date)}`
  : `${audit.auditor} &nbsp;&nbsp; Date: ${fmtNZ(audit.date)}`
}</td></tr>
  ...
  if (era === '2023') {
    const rows = items.map(([label],i) => {
      ...
      const cell = isFail
        ...
        : isNa
        ? `<span style="color:#666;font-size:9.5pt;font-weight:bold;">N/A</span>`
        : _tick(true,'2023');
      const noteCell = note ? note : (isFail ? 'See notes' : '—');
      return `<tr><td>${label}</td><td style="text-align:center;width:65px;">${cell}</td><td style="width:200px;font-size:9.5pt;color:#444;">${noteCell}</td></tr>`;
    }).join('');
    return `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>${title} ${fmtNZ(audit.date)}</title>
<style>
...
<h2>Summary</h2>
<table class="meta">
<tr><th>Total items</th><td>${items.length}</td><th>Passed</th><td>${items.length - failSet.size - naSet.size}</td></tr>
<tr><th>Failed</th><td>${failSet.size}</td><th>N/A</th><td>${naSet.size}</td></tr>
</table>
...
<h2>Sign-off</h2>
<table class="meta">
<tr><th>Auditor signature</th><td>${resolvedSig
  ? `<img src="${resolvedSig}" alt="signature" style="max-height:36px;max-width:200px;vertical-align:middle;"/>&nbsp;&nbsp;Date: ${fmtNZ(audit.date)}`
  : `<span style="font-family:'Comic Sans MS',cursive;font-size:18pt;color:#1a1a7a;">${audit.auditor}</span>&nbsp;&nbsp;Date: ${fmtNZ(audit.date)}`
}</td></tr>
...
<div class="footer">Total Body Physio Ltd · ${title} · ${fmtNZ(audit.date)} · ${audit.clinic} · Ref: ${ref}</div>
  ...
  if (era === '2024a') {
    const rows = items.map(([label],i) => {
      ...
      const isNa   = naSet.has(i);
      const note   = noteFor[i] || '';
      const bg = isFail ? '#fdecea' : isNa ? '#f4f3ee' : '#e8f8ec';
      const cell = isFail
        ? `<span style="color:#c0392b;font-weight:bold;">✗ Fail</span>`
        : isNa
        ? `<span style="color:#666;font-size:9.5pt;font-weight:bold;">N/A</span>`
        : _tick(true,'2024');
      const noteCell = note ? note : (isFail ? 'See notes below' : '—');
      return `<tr><td>${label}</td><td style="text-align:center;width:70px;background:${bg};">${cell}</td><td style="width:190px;font-size:9.5pt;color:#555;">${noteCell}</td></tr>`;
    }).join('');
    return `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>${title} ${fmtNZ(audit.date)}</title>
<style>
...
<table class="meta">
<tr><th>Total items</th><td>${items.length}</td><th>Passed</th><td>${items.length - failSet.size - naSet.size}</td></tr>
<tr><th>Failed</th><td>${failSet.size}</td><th>Overall</th><td><div class="outcome">${passed?'PASSED':'ISSUES FOUND'}</div></td></tr>
</table>
<h2>Notes &amp; actions</h2>
...
<table class="meta">
<tr><th>Auditor signature</th><td>${resolvedSig
  ? `<img src="${resolvedSig}" alt="signature" style="max-height:40px;max-width:240px;vertical-align:middle;"/>&nbsp;&nbsp;Date: ${fmtNZ(audit.date)}`
  : `<span class="sig">${audit.auditor}</span>&nbsp;&nbsp;Date: ${fmtNZ(audit.date)}`
}</td></tr>
...
<div class="footer">Total Body Physio Ltd · ${title} · ${fmtNZ(audit.date)} · ${audit.clinic} · Ref: ${ref}</div>
  ...
  if (era === '2024b') {
    const rows = items.map(([label],i) => {
      ...
      const isNa   = naSet.has(i);
      const note   = noteFor[i] || '';
      const bg = isFail ? '#fdecea' : isNa ? '#f4f3ee' : '#f0faf4';
      const cell = isFail
        ? `<span style="color:#c0392b;font-weight:bold;">✗ Fail</span>`
        : isNa
        ? `<span style="color:#666;font-size:9.5pt;font-weight:bold;">N/A</span>`
...
<h2>Outcome</h2>
<table class="meta">
<tr><th>Items checked</th><td>${items.length}</td><th>Passed</th><td style="color:#1a6e1a;font-weight:bold;">${items.length - failSet.size - naSet.size}</td></tr>
<tr><th>Failed</th><td style="color:${failSet.size?'#c0392b':'inherit'};font-weight:${failSet.size?'bold':'normal'};">${failSet.size}</td><th>N/A</th><td>${naSet.size}</td></tr>
</table>
<div class="outcome">${passed?'✓  Passed':'✗  Issues found'}</div>
...
<table class="meta">
<tr><th>Auditor signature</th><td>${resolvedSig
  ? `<img src="${resolvedSig}" alt="signature" style="max-height:42px;max-width:240px;vertical-align:middle;"/>&nbsp;&nbsp;Date: ${fmtNZ(audit.date)}`
  : `<span style="font-family:'Brush Script MT','Apple Chancery',cursive;font-size:20pt;color:#0a2a5a;">${audit.auditor}</span>&nbsp;&nbsp;Date: ${fmtNZ(audit.date)}`
}</td></tr>
...
<div class="footer">Total Body Physio Ltd · ${title} · ${fmtNZ(audit.date)} · ${audit.clinic} · Ref: ${ref} · Confidential</div>
  ...
  if (era === '2025a') {
    const rows = items.map(([label],i) => {
      ...
      const isNa   = naSet.has(i);
      const note   = noteFor[i] || '';
      const bg = isFail ? '#fdecea' : isNa ? '#f4f3ee' : (i%2===0?'#ffffff':'#f9fdf9');
      const cell = isFail
        ? `<span style="color:#c0392b;font-weight:700;font-size:12pt;">✗</span>`
        : isNa
        ? `<span style="color:#8B8680;font-size:9.5pt;font-weight:600;">N/A</span>`
        : _tick(true,'2025a');
      const noteCell = note ? note : (isFail ? 'See notes' : '—');
      return `<tr style="background:${bg};"><td style="padding:6px 14px;">${label}</td>
        <td style="text-align:center;width:72px;padding:6px;">${cell}</td>
        <td style="width:200px;font-size:9.5pt;color:#666;padding:6px 12px;">${noteCell}</td></tr>`;
    }).join('');
...
<h2>Summary</h2>
<table class="meta">
<tr><th>Total items</th><td>${items.length}</td><th>Passed</th><td style="color:#0F6E56;font-weight:600;">${items.length - failSet.size - naSet.size}</td></tr>
<tr><th>Failed</th><td style="color:${failSet.size?'#c0392b':'inherit'};font-weight:${failSet.size?'600':'400'};">${failSet.size}</td><th>N/A</th><td>${naSet.size}</td></tr>
</table>
...
<h2>Sign-off</h2>
<table class="meta">
<tr><th>Auditor</th><td>${resolvedSig
  ? `<img src="${resolvedSig}" alt="signature" style="max-height:42px;max-width:260px;display:inline-block;vertical-align:middle;"/>&nbsp;&nbsp;&nbsp;<span style="font-size:9.5pt;color:#666">${audit.signedBy||audit.auditor} · ${fmtNZ(audit.date)}</span>`
...
<div class="footer"><span>Total Body Physio Ltd · ${title}</span><span>${fmtNZ(audit.date)} · ${audit.clinic} · Ref: ${ref} · Confidential</span></div>
  ...
  const rows = items.map(([label],i) => {
    ...
    const isNa   = naSet.has(i);
    const note   = noteFor[i] || '';
    const bg = isFail ? '#fdecea' : isNa ? '#f4f3ee' : (i%2===0?'#ffffff':'#F7F9FC');
    const cell = isFail
      ? `<span style="color:#c0392b;font-weight:700;font-size:12pt;">✗</span>`
      : isNa
      ? `<span style="color:#8B8680;font-size:9.5pt;font-weight:600;">N/A</span>`
    ...
    return `<tr style="background:${bg};"><td style="padding:7px 14px;">${label}</td>
      <td style="text-align:center;width:72px;padding:7px;">${cell}</td>
      <td style="width:200px;font-size:9.5pt;color:#666;padding:7px 12px;">${noteCell}</td></tr>`;
  }).join('');
...
<h2>Summary</h2>
<table class="meta">
<tr><th>Total items</th><td>${items.length}</td><th>Passed</th><td style="color:#1F3A5F;font-weight:600;">${items.length - failSet.size - naSet.size}</td></tr>
<tr><th>Failed</th><td style="color:${failSet.size?'#c0392b':'inherit'};font-weight:${failSet.size?'600':'400'};">${failSet.size}</td><th>N/A</th><td>${naSet.size}</td></tr>
</table>
<div style="margin-bottom:16px;"><div class="outcome">${passed?'✓  Passed':'✗  Issues found'}</div></div>
<h2>Notes &amp; actions</h2>
...
<tr><th>Auditor</th><td>
  ${resolvedSig
    ? `<div class="attestation" style="padding:10px 16px;">
         <div style="margin-bottom:4px;"><img src="${resolvedSig}" alt="signature" style="max-height:56px;max-width:260px;display:block;"/></div>
            ...
            {audit.signature
              ? <>
                  <div style={{background:"#fff",border:`1px solid ${C.border}`,borderRadius:6,padding:10,display:"inline-block",maxWidth:"100%"}}>
                    <img src={sigSrcFor(audit, audit.signature)} alt="signature" style={{maxHeight:60,maxWidth:260,display:"block"}}/>
                  </div>
...
function AuditViewModal_2025({audit,onClose}){
  ...
  // Fall back to all-pass for historical audits without itemChecks when the
  // overall outcome was Passed, so ticks render rather than em-dashes.
  const realChecks = audit.itemChecks && Object.keys(audit.itemChecks).length;
  const defaultMark = (!realChecks && (audit.failed||0) === 0) ? "pass" : null;
  const checks = realChecks ? audit.itemChecks : {};
  const itemNotes=audit.itemNotes||{};
  const sigSrc = resolveAuditSignature(audit);
        ...
        <div style={{padding:"22px 28px 24px",maxHeight:"72vh",overflowY:"auto"}}>
          {sections.length > 0 ? sections.map((sec,si) => (
            <div key={si} style={{marginBottom:"26px"}}>
              ...
              {sec.items.map((item,ii) => {
                const k = `${si}-${ii}`;
                const val = checks[k] || defaultMark;
          ...
          <div style={{marginTop:28,paddingTop:20,borderTop:`1px solid ${C.grayL}`,display:"flex",justifyContent:"space-between",alignItems:"flex-end",gap:24}}>
            <div>
              ...
              {sigSrc
                ? <>
                    <img src={sigSrc} alt="signature" style={{maxHeight:50,maxWidth:220,display:"block"}}/>
...
function AuditViewModal_2024({audit,onClose}){
  const form=AUDIT_FORMS[audit.type]||{sections:[]};
  const sections=audit.sections||form.sections||[];
  // For historical audits without per-item itemChecks, default each item to
  // its outcome-driven status: "pass" if the audit was Passed; otherwise we
  // leave them blank so the original em-dash hints at incomplete data.
  const realChecks = audit.itemChecks && Object.keys(audit.itemChecks).length;
  const defaultMark = (!realChecks && (audit.failed||0) === 0) ? "pass" : null;
  const checks = realChecks ? audit.itemChecks : {};
  const itemNotes=audit.itemNotes||{};
            ...
            <div>
              ...
              {sigSrc
                ? <div style={{borderBottom:"1px solid #333",paddingBottom:3,minHeight:36,display:"flex",alignItems:"flex-end"}}>
                    <img src={sigSrc} alt="signature" style={{maxHeight:36,maxWidth:220,display:"block"}}/>
                  </div>
...
function AuditViewModal_2023({audit,onClose}){
  ...
  const sections=audit.sections||form.sections||[];
  // For historical audits without per-item itemChecks, default each item to
  // "pass" when the audit was Passed so ticks render rather than em-dashes.
  const realChecks = audit.itemChecks && Object.keys(audit.itemChecks).length;
  const defaultMark = (!realChecks && (audit.failed||0) === 0) ? "pass" : null;
  const checks = realChecks ? audit.itemChecks : {};
  const itemNotes=audit.itemNotes||{};
        ...
        <div style={{padding:"24px 28px",maxHeight:"80vh",overflowY:"auto"}}>
          ...
          <div style={{marginTop:26}}>
            <div style={{fontSize:12}}>
              Signed: {sigSrc
                ? <img src={sigSrc} alt="signature" style={{maxHeight:30,maxWidth:180,verticalAlign:"middle",marginLeft:4}}/>
            ...
            {audit.signature
              ? <>
                  <div style={{background:"#fff",border:`1px solid ${C.border}`,borderRadius:6,padding:8,display:"inline-block",maxWidth:"100%"}}>
                    <img src={sigSrcFor(audit, audit.signature)} alt="signature" style={{maxHeight:56,maxWidth:240,display:"block"}}/>
                  </div>
                  <div style={{fontSize:11,color:C.muted,marginTop:5,fontFamily:"monospace"}}>{audit.signedBy||audit.auditor} · signed {audit.signedAt?fmtNZ(audit.signedAt.slice(0,10)):fmtNZ(audit.date)}</div>
                </>
        ...
        <div style={{padding:"1.25rem 1.5rem",maxHeight:"72vh",overflowY:"auto"}}>
          ...
          <div style={{marginTop:"1rem",padding:"0.875rem",background:"#F5F0FB",border:`1px solid #c7b8e0`,borderRadius:8}}>
            ...
            {audit.signature
              ? <>
                  <div style={{background:"#fff",border:`1px solid ${C.border}`,borderRadius:6,padding:8,display:"inline-block",maxWidth:"100%"}}>
                    <img src={sigSrcFor(audit, audit.signature)} alt="reviewer signature" style={{maxHeight:56,maxWidth:240,display:"block"}}/>
                  </div>
...
const PRELOADED_SIGNATURES = {
  ...
  alistair: "data:image/png;base64,",
};
...
function ItemCheckRetrofillButton(){
  ...
  const [scanKind, setScanKind] = useState("missing"); // 'missing' or 'redo-generic'
  ...
  const scan = (kind = "missing") => {
    ...
    try {
      ...
      if(cands.length === 0){
        setMode("idle");
        setMsg(kind === "redo-generic"
          ? "✓ No records with generic \"Item N\" names found."
          : "✓ No records need item-check retrofilling. All generic audits already have item-level data.");
      } else {
        setMode("preview");
        setMsg("");
      }
  ...
  const apply = async () => {
    ...
    try {
      ...
      const updated = audits.map(a => {
        ...
        // STRONGLY prefer today's real template when it exists, because earlier
        // retrofill passes may have stored a corrupted `total` field that no
        // longer matches the real form. Falling back to today's template heals
        // those records by swapping generic "Item N" names with real item text
        // and redistributing the pass/fail/na counts across the new item slots.
        const storedSum = (a.passed||0) + (a.failed||0) + (a.na||0);
        const targetTotal = (todayTotal > 0) ? todayTotal
                          : (a.total && a.total > 0) ? a.total
                          : (storedSum > 0 ? storedSum : 10);

        // Build items + section mapping. Use today's real template whenever
        // possible. Only fall back to generic "Item N" when no template exists.
        let sections;
        let flat = [];
        if(form && form.sections){
          ...
          // Last-resort fallback — no form definition available
          sections = [{
            title: "Audit items",
    ...
    <div>
      {mode === "idle" && (
        <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
          ...
          <button onClick={() => scan("redo-generic")}
            style={{background:"white",border:`1.5px solid ${C.muted}`,color:C.muted,borderRadius:8,padding:"9px 18px",fontSize:12,fontWeight:600,cursor:"pointer"}}
            title="Re-process records where items currently look like 'Item 1, Item 2…' — will replace with real item names if today's template matches the record's count."
          >🔄 Redo records with generic "Item N" names</button>
        </div>
      )}
